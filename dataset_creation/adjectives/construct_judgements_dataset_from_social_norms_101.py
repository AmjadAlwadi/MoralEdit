...
# Load the datasets
social_chemistry = load_dataset(f"{datasets_path}/social-chem-101/", data_files="social-chem-101.v1.0.tsv", split='train')
...
very_bad_dataset.to_json(f"{datasets_path}/norms/very_bad_dataset.json")
bad_dataset.to_json(f"{datasets_path}/norms/bad_dataset.json")
ok_dataset.to_json(f"{datasets_path}/norms/ok_dataset.json")
good_dataset.to_json(f"{datasets_path}/norms/good_dataset.json")
very_good_dataset.to_json(f"{datasets_path}/norms/very_good_dataset.json")
